...
!$xmp align (i,j) with tmplt(i,j) :: density0, volume, pressure, viscosity, xarea, yarea, xvel0, yvel0, xvel1, yvel1
!$xmp shadow (2:2, 2:2) :: density0, volume, pressure, viscosity
!$xmp shadow (2:3, 2:2) :: xarea
!$xmp shadow (2:2, 2:3) :: yarea
!$xmp shadow (2:3, 2:3) :: xvel0, yvel0, xvel1, yvel1
!$xmp save_desc :: p, tmplt, density0, volume, pressure, viscosity, xarea, yarea, xvel0, yvel0, xvel1, yvel1
...
!$xmp loop (j,k) on tmplt(j,k) expand(0:1,0:1)
!$OMP PARALLEL DO PRIVATE(j,k,stepbymass_s)
    DO k=y_min,y_max+1
      DO j=x_min,x_max+1
