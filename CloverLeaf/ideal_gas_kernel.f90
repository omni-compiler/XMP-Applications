...
!$xmp align (i,j) with t(i,j) :: density, energy, pressure, soundspeed
!$xmp shadow (2:2, 2:2) :: density, energy, pressure, soundspeed
!$xmp save_desc :: p, t, density, energy, pressure, soundspeed
...
!$OMP PARALLEL DO PRIVATE(v,pressurebyenergy,pressurebyvolume,sound_speed_squared)
    DO k=y_min,y_max
      DO j=x_min,x_max
        v=1.0_8/density(j,k)
