...
!$xmp align (i,j) with t(i,j) :: xarea, vol_flux_x, yarea, vol_flux_y, xvel0, xvel1, yvel0, yvel1
!$xmp shadow (2:3, 2:2) :: xarea, vol_flux_x
!$xmp shadow (2:2, 2:3) :: yarea, vol_flux_y
!$xmp shadow (2:3, 2:3) :: xvel0, xvel1, yvel0, yvel1
!$xmp save_desc :: p, t, xarea, vol_flux_x, yarea, vol_flux_y, xvel0, xvel1, yvel0, yvel1
!!$OMP PARALLEL
