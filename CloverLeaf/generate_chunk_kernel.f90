...
!$xmp align (i) with t(i,*) :: vertexx, cellx
!$xmp align (j) with t(*,j) :: vertexy, celly
!$xmp align (i,j) with t(i,j) :: density0, energy0, xvel0, yvel0
!$xmp shadow (2:3) :: vertexx, vertexy
!$xmp shadow (2:2) :: cellx, celly
!$xmp shadow (2:2, 2:2) :: density0, energy0
...
!$OMP PARALLEL DO PRIVATE(radius,jt,kt) PRIVATE(j)
      DO k=y_min-2,y_max+2
        DO j=x_min-2,x_max+2
