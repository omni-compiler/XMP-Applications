...
contains
  ...
  subroutine COMM_setup( &
    ...
    integer:: ll
    integer :: colc(10),valc(10)
    !--- 2020 Fujitsu
    integer(8) :: sendbuf_l_lb(2), sendbuf_l_ub(2)
    !--- 2020 Fujitsu end
    !
    ! Iga(061008) ==> 
    namelist / COMMPARAM /   &
...
!coarray
       ...
       call mpi_bcast(                  &
            ...
            ADM_comm_run_world,             &
            ierr)
       !call co_broadcast(rsize_r2r(:,:,l),prc_tab_rev(ptr_prcid,l))
       !--- 2020 Fujitsu end
    end do
    !--- 2020 Fujitsu
    !sync all
...
!coarray
       ...
       call mpi_bcast(                  &
            ...
            ADM_comm_run_world,             &
            ierr)
       !call co_broadcast(sourceid_r2r(:,:,l),prc_tab_rev(ptr_prcid,l))
       !--- 2020 Fujitsu end
    end do
    !(20101207)removed by teraim
    !do l=1,ADM_rgn_nmax
...
!coarray
       ...
       call mpi_bcast(                  &
            ...
            ADM_comm_run_world,             &
            ierr)
       !call co_broadcast(maxcommrecv_r2r(:,l),prc_tab_rev(ptr_prcid,l))
       !--- 2020 Fujitsu end
    end do
    !--- 2020 Fujitsu
    !sync all
...
!coarray
       ...
       call mpi_bcast(                  &
            ...
            ADM_comm_run_world,             &
            ierr)
       !call co_broadcast(rlist_r2r(:,:,:,l),prc_tab_rev(ptr_prcid,l))
       !--- 2020 Fujitsu end
    end do
    !--- 2020 Fujitsu
    !sync all
...
!coarray
       ...
       call mpi_bcast(                  &
            ...
            ADM_comm_run_world,             &
            ierr)
       !call co_broadcast(qlist_r2r(:,:,:,l),prc_tab_rev(ptr_prcid,l))
       !--- 2020 Fujitsu end
    end do
    !--- 2020 Fujitsu
    !sync all
...
!coarray
       ...
       call mpi_bcast(                  &
            ...
            ADM_comm_run_world,             &
            ierr)
       !call co_broadcast(n_hemisphere_copy(:,:,l),prc_tab_rev(ptr_prcid,l))
       !--- 2020 Fujitsu end
    end do
    !--- 2020 Fujitsu
    !sync all
...
!coarray
       ...
       call mpi_bcast(                  &
            ...
            ADM_comm_run_world,             &
            ierr)
       !call co_broadcast(s_hemisphere_copy(:,:,l),prc_tab_rev(ptr_prcid,l))
       !--- 2020 Fujitsu end
    end do
...
!coarray
       ...
       call mpi_bcast(                  &
            ...
            ADM_comm_run_world,             &
            ierr)
       !call co_broadcast(destid_r2r(:,:,l),prc_tab_rev(ptr_prcid,l))
       !--- 2020 Fujitsu end
    end do
    !--- 2020 Fujitsu
    !sync all
...
!coarray
       ...
       call mpi_bcast(                  &
            ...
            ADM_comm_run_world,             &
            ierr)
       !call co_broadcast(ssize_r2r(:,:,l),prc_tab_rev(ptr_prcid,l))
       !--- 2020 Fujitsu end
    end do
    !(20101207)removed by teraim
    !do l=1,ADM_rgn_nmax
...
!coarray
       ...
       call mpi_bcast(                  &
            ...
            ADM_comm_run_world,             &
            ierr)
       !call co_broadcast(slist_r2r(:,:,:,l),prc_tab_rev(ptr_prcid,l))
       !--- 2020 Fujitsu end
    end do
    !--- 2020 Fujitsu
    !sync all
...
!coarray
       ...
       call mpi_bcast(                  &
            ...
            ADM_comm_run_world,             &
            ierr)
       !call co_broadcast(maxcommsend_r2r(:,l),prc_tab_rev(ptr_prcid,l))
       !--- 2020 Fujitsu end
    end do
    !--- 2020 Fujitsu
    !sync all
...
!coarray
       ...
       call mpi_bcast(                  &
            ...
            ierr)
       !colc(:) = tempsb(l)%col(:)
       !call co_broadcast(colc,prc_tab_rev(ptr_prcid,l))
       !tempsb(l)%col(:) = colc(:)
       !--- 2020 Fujitsu end
!coarray
       !--- 2020 Fujitsu
       call mpi_bcast(                  &
            ...
            ierr)
       !valc(:) = tempsb(l)%val(:)
       !call co_broadcast(valc,prc_tab_rev(ptr_prcid,l))
       !tempsb(l)%val(:) = valc(:)
       !--- 2020 Fujitsu end
    enddo
...
!coarray
         ...
         call mpi_bcast(                    &
              ...
              ADM_comm_run_world,           &
              ierr)
         !colc(:) = tempsb(ADM_rgn_nmax+pl)%col(:)
         !call co_broadcast(colc,ADM_prc_nspl(pl))
         !tempsb(ADM_rgn_nmax+pl)%col(:) = colc(:)
         !--- 2020 Fujitsu end
!coarray
         !--- 2020 Fujitsu
         call mpi_bcast(                    &
              ...
              ADM_comm_run_world,           &
              ierr)
         !valc(:) = tempsb(ADM_rgn_nmax+pl)%val(:)
         !call co_broadcast(valc,ADM_prc_nspl(pl))
         !tempsb(ADM_rgn_nmax+pl)%val(:) = valc(:)
         !--- 2020 Fujitsu end
      enddo
    endif ! T.Ohno 110721
!coarray    call mpi_barrier(ADM_comm_run_world,ierr)
...
!coarray
       ...
       call mpi_bcast(                  &
            ...
            ADM_comm_run_world,             &
            ierr)
       !call co_broadcast(src_rank_all(:,:,l),l)
       !sync all
       call xmp_sync_all(ierr)
       !--- 2020 Fujitsu end
!coarray
       ...
       call mpi_bcast(                  &
            ...
            ADM_comm_run_world,             &
            ierr)
       !call co_broadcast(dest_rank_all(:,:,l),l)
       !--- 2020 Fujitsu end
    enddo
    !
!coarray    call MPI_Barrier(ADM_COMM_RUN_WORLD,ierr)
...
!       enddo
       ...
       if ( ADM_prc_me == ADM_prc_npl ) then
!coarray          call MPI_WAIT(ireq(3),istat,ierr)

          do n = 1, nnum
          do k = 1, knum
!coarray             var_pl(ADM_GSLF_PL,k,ADM_NPL,n) = v_npl_recv(k,n)
             var_pl(ADM_GSLF_PL,k,ADM_NPL,n) = v_npl_recvc(k,n)
          enddo
          enddo
       endif

       if ( ADM_prc_me == ADM_prc_spl ) then
!coarray          call MPI_WAIT(ireq(4),istat,ierr)

          do n = 1, nnum
          do k = 1, knum
!coarray             var_pl(ADM_GSLF_PL,k,ADM_SPL,n) = v_spl_recv(k,n)
             var_pl(ADM_GSLF_PL,k,ADM_SPL,n) = v_spl_recvc(k,n)
          enddo
          enddo
       endif
...
!          var_pl(ADM_GSLF_PL,:,ADM_NPL,:) = v_npl_recv(:,:)
          var_pl(ADM_GSLF_PL,:,ADM_NPL,:) = v_npl_recvc(:,:)
       endif
...
!          var_pl(ADM_GSLF_PL,:,ADM_SPL,:) = v_spl_recv(:,:)
          var_pl(ADM_GSLF_PL,:,ADM_SPL,:) = v_spl_recvc(:,:)
       endif
