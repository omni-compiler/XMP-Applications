...
{
  char *name=(char *)malloc(sizeof(char)*256);//[256];
...
{
//static char buf[20];
  char *buf=(char *)malloc(sizeof(char)*26);//[26];
  time_t t = time(NULL);
...
void c_setup_(const char *app_name, const char *app_version)
{
maprof_setup(app_name,app_version);
}
...
void maprof_add_section_(const char *name, int *id)
{
maprof_add_section(name,*id);
}

void c_add_section_(const char *name, int *id)
{
maprof_add_section(name,*id);
}
...
void c_app_add_str_(const char *key, const char *str)
{
maprof_app_add_str(key,str);
}
...
void c_app_add_int_(const char *key,int n)
{
maprof_app_add_int(key,n);
}
...
void c_app_add_float_(const char *key, double r)
{
maprof_app_add_float(key,r);
}
...
void c_profile_add_problem_size_(const char *key, int n)
{
 maprof_profile_add_problem_size(key,n);
}
...
void c_profile_add_str_(const char *key, const char *str)
{
maprof_profile_add_str(key,str);
}
...
void c_profile_add_int_(const char *key, int n)
{
 maprof_profile_add_int(key,n);
}
...
void c_profile_add_float_(const char *key, double r)
{
 maprof_profile_add_float(key,r);
}
