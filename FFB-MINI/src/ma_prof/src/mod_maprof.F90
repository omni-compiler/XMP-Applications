...
#define MAPROF_SD   4
   ...
   interface
    ...
    subroutine maprof_time_start(id)
      integer(kind=4) :: id 
    end subroutine maprof_time_start

    subroutine maprof_time_stop(id)
      integer(kind=4) :: id 
    end subroutine maprof_time_stop

    subroutine maprof_add_fp_ops(id, ops)
      integer(kind=4) :: id 
      real(kind=8) :: ops
    end subroutine maprof_add_fp_ops

    subroutine maprof_add_ld_ops(id, ops)
      integer(kind=4) :: id 
      real(kind=8) :: ops
    end subroutine maprof_add_ld_ops

    subroutine maprof_add_st_ops(id, ops)
      integer(kind=4) :: id 
      real(kind=8) :: ops
    end subroutine maprof_add_st_ops

    subroutine maprof_add_ld_min_ops(id, ops)
      integer(kind=4) :: id 
      real(kind=8) :: ops
    end subroutine maprof_add_ld_min_ops

    subroutine maprof_add_st_min_ops(id, ops)
      integer(kind=4) :: id 
      real(kind=8) :: ops
    end subroutine maprof_add_st_min_ops

    real(kind=8) function maprof_get_time(id, type)
      integer(kind=4) :: id 
      integer(kind=4) :: type
    end function maprof_get_time

    real(kind=8) function maprof_get_flops(id, type)
      integer(kind=4) :: id 
      integer(kind=4) :: type
    end function maprof_get_flops

    real(kind=8) function maprof_get_throughput(id, type)
      integer(kind=4) :: id 
      integer(kind=4) :: type
    end function maprof_get_throughput

    real(kind=8) function maprof_get_effective_throughput(id, type)
      integer(kind=4) :: id 
      integer(kind=4) :: type
    end function maprof_get_effective_throughput

    subroutine maprof_flush_stdout()
...
subroutine maprof_print_time(id, name)
  ...
  interface
    subroutine c_print_time(id, str)
      integer(kind=4) :: id 
      character(len=1), intent(in) :: str(*)
...
subroutine maprof_print_time_mpi(id, name)
  ...
  interface
    subroutine c_print_time_mpi(id, str)
      integer(kind=4) :: id 
      character(len=1), intent(in) :: str(*)
...
!$ use omp_lib
  ...
  interface
    subroutine c_setup(app_name, app_version)
      character(len=1), intent(in) :: app_name(*), app_version(*)
    end subroutine c_setup

    subroutine maprof_set_num_threads(n)
      integer(kind=4) :: n
...
subroutine maprof_app_add_str(key, str)
  ...
  interface
    subroutine c_app_add_str(key, str)
      character(len=1), intent(in) :: key(*), str(*)
...
subroutine maprof_app_add_int(key, n)
  ...
  interface
    subroutine c_app_add_int(key, n)
...
subroutine maprof_app_add_float(key, r)
  ...
  interface
    subroutine c_app_add_float(key, r)
      character(len=1), intent(in) :: key(*)
      real(kind=8) :: r
...
subroutine maprof_add_section(name, id)
  ...
  interface
    subroutine c_add_section(name, id)
...
subroutine maprof_profile_add_str(key, str)
  ...
  interface
    subroutine c_profile_add_str(key, str)
      character(len=1), intent(in) :: key(*), str(*)
...
subroutine maprof_profile_add_int(key, n)
  ...
  interface
    subroutine c_profile_add_int(key, n)
      character(len=1), intent(in) :: key(*)
      integer(kind=4) :: n
