...
!      use iso_c_binding
    ...
    real(kind=8) function maprof_get_time(id, type) !bind(c)
!      use iso_c_binding
      integer(kind=4) :: id 
      integer(kind=4) :: type
    end function maprof_get_time

    real(kind=8) function maprof_get_flops(id, type) !bind(c)
!      use iso_c_binding
      integer(kind=4) :: id 
      integer(kind=4) :: type
    end function maprof_get_flops

    real(kind=8) function maprof_get_throughput(id, type) !bind(c)
!      use iso_c_binding
      integer(kind=4) :: id 
      integer(kind=4) :: type
    end function maprof_get_throughput

    real(kind=8) function maprof_get_effective_throughput(id, type) !bind(c)
!      use iso_c_binding
      integer(kind=4) :: id 
      integer(kind=4) :: type
